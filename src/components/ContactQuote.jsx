  ...
  return (
    <section className="relative min-h-screen w-full">
      <div className="absolute inset-0 w-full h-full">
        <img src={contactbg} alt="Banner" className="w-full h-full object-cover" />
      </div>
            ...
            <div className="bg-[#101840] backdrop-blur-md text-white p-6 sm:p-8 lg:p-10 flex flex-col justify-between min-h-[500px] sm:min-h-[600px] shadow-xl">
              <div>
                ...
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-[#14b8a6] rounded-lg flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-[#14b8a6]" />
                  </div>
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold">{t('contactQuote.location.address')}</h3>
                  </div>
                </div>
                ...
                <div className="space-y-4 sm:space-y-5">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-[#14b8a6] rounded-lg flex items-center justify-center flex-shrink-0">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-[#14b8a6]" />
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm text-gray-300">{t('contactQuote.quickContact.callUs')}</p>
                      <p className="text-base sm:text-lg font-semibold">+966 0557236549</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-[#14b8a6] rounded-lg flex items-center justify-center flex-shrink-0">
                      <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-[#14b8a6]" />
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm text-gray-300">{t('contactQuote.quickContact.emailUs')}</p>
                      <p className="text-sm sm:text-base font-semibold break-all">contact@riyadhrepairingservices.com</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-600 pt-4 mt-6">
                ...
                <p className="text-lg sm:text-xl font-bold">{t('contactQuote.businessHours.time')}</p>
              </div>
            </div>
            ...
            <div className="bg-white/30 backdrop-blur-[30px] p-6 sm:p-8 lg:p-10 relative overflow-hidden min-h-[500px] sm:min-h-[600px] shadow-xl">
              <div className="mb-4 sm:mb-6">
                <div className="flex items-center gap-2 text-[#14b8a6] mb-2">
                  ...
                  <span className="text-xs sm:text-sm font-semibold uppercase tracking-wide">{t('contactQuote.form.badge')}</span>
                </div>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0A1033]">{t('contactQuote.form.title')}</h2>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div className="relative">
                    <select
                      ...
                      required
                    >
                      <option value="">{t('contactQuote.form.subjectPlaceholder')}</option>
                      <option value="general">{t('contactQuote.form.subjects.general')}</option>
                      <option value="repair">{t('contactQuote.form.subjects.repair')}</option>
                      <option value="maintenance">{t('contactQuote.form.subjects.maintenance')}</option>
                      <option value="installation">{t('contactQuote.form.subjects.installation')}</option>
                    </select>
                  </div>
                </div>
