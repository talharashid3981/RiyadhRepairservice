...
import contactbg from "../assets/images/contactBackground.webp";
...
const ContactQuote = () => {
  ...
  return (
    <section className="relative min-h-screen w-full">
      ...
      <div className="relative w-full h-full flex justify-center px-4 sm:px-6 lg:px-10 xl:px-9 2xl:px-12 ">
        <div className="max-w-[1920px] w-full mx-auto">
          <div className="w-full border-4 sm:border-8 lg:border-12 xl:border-16 2xl:border-20 border-white mb-5">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch">
              {/* LEFT SECTION */}
              <div className="bg-[#101840] backdrop-blur-md text-white px-4 sm:px-6 lg:px-10 xl:px-12 2xl:px-20 py-8 sm:py-10 lg:py-12 flex flex-col justify-between min-h-[500px] sm:min-h-[600px] shadow-xl">
                <div>
                  {/* Address Section */}
              ...
              {/* RIGHT SECTION (Form) */}
              <div className="bg-white/30 backdrop-blur-[30px] px-4 sm:px-6 lg:px-10 xl:px-12 2xl:px-20 py-8 sm:py-10 lg:py-12 relative overflow-hidden min-h-[500px] sm:min-h-[600px] shadow-xl">
