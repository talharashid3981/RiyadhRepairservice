...
import washing_machine_repear_bannerimg from "../assets/images/washing_machine_repear_bannerimg.webp";
import Refrigerator_banner from "../assets/images/Refrigerator_banner.webp";
...
const ACRepairSlider = () => {
  ...
  return (
    ...
    >
      <h1 className="sr-only">{t("acRepairSlider.slides.0.description")}</h1>
