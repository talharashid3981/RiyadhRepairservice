...
const ClientReview = () => {
  ...
  return (
    <div className="bg-[#0a0d2e]">
      <div className="max-w-[1920px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          {/* Left side - Content */}
          <div className="relative flex items-center px-4 sm:px-6 lg:px-10 xl:px-12 2xl:px-20 py-10 sm:py-12 lg:py-16">
            ...
            <div className="absolute right-4 sm:right-6 lg:right-1 xl:right-1 2xl:right-20 z-90 top-1/2 -translate-y-1/2 hidden xl:flex flex-col gap-3">
          ...
          <div className="relative h-full lg:min-h-screen">
            ...
            <div className="absolute inset-0 bg-gradient-to-l from-transparent via-[#0a0d2e]/20 to-[#0a0d2e]" />
          </div>
        </div>
      </div>
    </div>
