...
const Footer = () => {
  ...
  return (
    <footer className="relative text-gray-300 text-sm overflow-hidden">
      ...
      {/* 🔥 FIXED: Newsletter Section - Consistent Padding */}
      <div className="border-b border-gray-700 py-6 sm:py-8">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 2xl:px-20 text-center">
      ...
      {/* 🔥 FIXED: Main Footer Content - Consistent Padding */}
      <div className="border-b border-gray-700 py-8 sm:py-10">
            ...
            <div className="flex w-full sm:w-60 items-start justify-center sm:justify-start">
              ...
              >
                ...
                <div className="flex flex-col justify-center leading-[1.1]">
                  <h2 className="text-[18px] sm:text-[22px] font-extrabold text-[#14b8a6] tracking-wide group-hover:text-[#0d9488] transition-colors whitespace-nowrap">
                    RIYADH
                  </h2>
                  <h3 className="text-[14px] sm:text-[18px] font-semibold text-white">
                    REPAIR SERVICES
                  </h3>
                  <p className="hidden sm:block text-[12px] text-gray-400 italic leading-tight">
                    {t("footer.tagline")}
                  </p>
                </div>
              </NavLink>
      ...
      {/* 🔥 FIXED: Bottom Footer - Consistent Padding */}
      <div className="py-4">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 2xl:px-20">
          <div className="flex flex-col sm:flex-row justify-between items-center text-gray-400 text-xs space-y-3 sm:space-y-0 gap-4">
